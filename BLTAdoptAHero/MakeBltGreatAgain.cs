...
public class BLTResurrectModule : MBSubModuleBase
    {
        ...
        protected override void OnSubModuleLoad()
        {
            ...
            // PatchAll covered by BLTAdoptAHeroModule — wywołanie stąd duplikowałoby patche
...
public class BLTFormationModule : MBSubModuleBase
    {
        ...
        protected override void OnSubModuleLoad()
        {
            ...
            try
            {
                ...
                // PatchAll covered by BLTAdoptAHeroModule
        ...
        {
            if (mission.PlayerEnemyTeam == null) return;
