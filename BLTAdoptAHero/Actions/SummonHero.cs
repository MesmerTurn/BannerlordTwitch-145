...
namespace BLTAdoptAHero
{
    ...
    internal class SummonHero : HeroActionHandlerBase
    {
        ...
        private class Settings : IDocumentable
        {
            ...
            [LocDisplayName("{=NavalBattle}Allow Naval Battle"),
             LocCategory("Allowed Missions", "{=i8P1EnE1}Allowed Missions"),
             LocDescription("{=NavalBattleDesc}Can summon in naval battles (retinue never spawns on ships)"),
             PropertyOrder(4), UsedImplicitly]
            public bool AllowNavalBattle { get; set; } = true;
            ...
            Action<string> onSuccess, Action<string> onFailure)
        {
            ...
            // SpawnAgent crashes if called in MissionMode.Deployment
            if (Mission.Current == null
                || Mission.Current.Mode is MissionMode.Deployment or MissionMode.Barter or MissionMode.Conversation or
            ...
            Action<string> onFailure)
        {
            ...
            {
                onFailure("{=NoSpawnSpace}No space to spawn on the battlefield!".Translate());
                return;
            }
